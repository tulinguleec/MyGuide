...
// Rehberin geçmişte açtığı turları getiren sorgu
$sql = "SELECT tur.tur_id,tur.tur_ad,tur.tur_fiyat,tur.tur_saat,tur.tur_tarih,il.il_ad,diller.dil_ad,tur.tur_gorsel,tur.tur_aciklama
FROM il INNER JOIN tur ON il.il_id=tur.tur_id
INNER JOIN rehber ON tur.rehber_id=rehber.rehber_id
INNER JOIN diller ON rehber.dil_id = diller.dil_id
WHERE rehber.user_id = ? AND tur.tur_tarih < ?
ORDER BY tur.tur_tarih DESC";
...
<body>
    <div class="containera">
        ...
        <h2 class="heading text-capitalize text-center">Geçmiş Turlarım</h2>
        ...
        ?>
                    <div class="col-lg-3 col-sm-6 mb-5">
                        ...
                        <div class="package-info">
                            ...
                            <h5 class="my-2">Turun Adı : <span><?php echo $row["tur_ad"]; ?></h5>
                            <h6 class="mt-1"><span class="fa fa-calendar"></span><?php echo $row["tur_tarih"];?></h6>
                            <h6 class="mt-1"><?php echo $row["tur_saat"];?></h6>
                            <p>Daha Fazla Bilgi <span><?php echo $row["tur_aciklama"]; ?></p>
                            <ul class="listing mt-3">
                                <li><span class="fa fa-money mr-2"></span>Ücret : <span><?php echo $row["tur_fiyat"]; ?></span></li>
                            </ul>
                            <div class="text-center mt-4">
                                <button class="btn btn-primary btn-lg cancel-btn" data-tur-id="<?php echo $row["tur_id"]; ?>" data-user-id="<?php echo $user_id; ?>">Rezervasyonu Tamamladınız</button>
                            </div>
                        </div>
        ...
        <?php
                ...
                echo "Henüz geçmişte kalmış bir rezervasyonunuz bulunmamaktadır.";
            }
        ?>
        </div>
    </div>
